...
const (
	...
	CustomQueryExchangeCacheRead            = "custom_query_exchange_cache_read"
	CustomQueryExchangeLiveFetch            = "custom_query_exchange_live_fetch"
	CustomQueryExchangeRefresher            = "custom_query_exchange_refresher"
